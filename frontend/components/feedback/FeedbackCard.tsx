...
export function FeedbackCard({ original, corrected, explanation, onOpen }: FeedbackCardProps) {
  return (
    <button
      ...
      className="relative block h-40 w-full shrink-0 border-0 bg-transparent p-0 text-left focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-accent/30"
      onClick={onOpen}
      type="button"
    >
      <img
